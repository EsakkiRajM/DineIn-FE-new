...
export function MyBookingModal({ showMyBookingModal, setShowMyBookingModal }) {
  ...
  useEffect(() => {
    if (username) {
      axios.get(`${apiuri}/mybookings/${username}`).then((response) => {
  ...
  const handleCancelBooking = (bookingId) => {
    axios
      .put(`${apiuri}/cancelBooking/${username}/${bookingId}`)
      .then((response) => {
        if (response.data) {
